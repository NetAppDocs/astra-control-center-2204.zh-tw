...
=== image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-1.png["一"] 備份所有應用程式
...
=== image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-3.png["三"] 選用：調整保護原則
...
=== image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-4.png["四"] 發生災難時、請還原您的應用程式
